...
IterationRetval_t CRagdollEnumerator::EnumElement( IHandleEntity *pHandleEntity )
{
	...
	// This seems to make ragdolls sometimes duplicate on death. This is confusing as fuck. dual ragdoll duplicate ragdoll clone ragdoll two ragdoll
	// Attempt to prevent crash -BillySB
	if (pEnt->m_iClassname == NULL)
		return ITERATION_CONTINUE;
